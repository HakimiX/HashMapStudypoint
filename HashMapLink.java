...
public class HashMapLink<K,V> implements Map<K,V> 
{
    ...
    public V remove(K key)
    {
        ...
        Link<K,V> val1 = array[index];
        Link<K,V> val2 = array[index];
        
        while(true){
            if(val1.getEntry().getKey().equals(key)){
                V value = val1.getEntry().getValue();
                
                if(val1.getEntry().getKey().equals(val2.getEntry().getKey())){
                    
                    if(val1.getNext() != null){
                        array[index] = val1.getNext();
                    } else {
                        array[index] = null;
                    }
                
                } else {
                    val2.setNext(val1.getNext());
                }
